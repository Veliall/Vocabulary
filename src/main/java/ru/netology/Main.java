...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printVocab(getVocabulary("Якорь Азбука Букварь Слово Едрени-фени Велик Группа Дверь Зверь Труп"));
...
//    плюс "чистота" методов, детерминированость и отсутствие сайд-эффектов
    public static List<String> getVocabulary(String string) {
        return Arrays.stream(string.split(" ")).sorted().collect(Collectors.toList());
    }
